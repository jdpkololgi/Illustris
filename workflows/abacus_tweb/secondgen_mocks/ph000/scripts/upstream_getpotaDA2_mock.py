...
if args.mock == 'ab2ndgen':
    ...
    # Per-tile reads use `columns=tarcols`; keep in sync with forFA from upstream_prepare_mocks_Y3_bright.
    # Redshift naming on forFA: Z = observed/RSD, Z_COSMO = true; TRUEZ/RSDZ may duplicate those for LSS.
